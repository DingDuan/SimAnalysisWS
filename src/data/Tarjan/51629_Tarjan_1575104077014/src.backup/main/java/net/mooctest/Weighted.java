...
public class Weighted<T> implements Comparable<Weighted<T>> {
	...
	public int compareTo(Weighted<T> other) {
		return ComparisonChain.start().compare(other.weight, weight)
				.compare(Objects.hashCode(other.val), Objects.hashCode(val)).result();
	}
	...
	public String toString() {
		return Objects.toStringHelper(this).add("val", val).add("weight", weight).toString();
	}
}
