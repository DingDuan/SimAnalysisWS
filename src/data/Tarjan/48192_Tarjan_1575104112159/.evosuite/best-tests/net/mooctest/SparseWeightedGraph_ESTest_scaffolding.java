...
public class SparseWeightedGraph_ESTest_scaffolding {
  ...
  private static void initMocksToAvoidTimeoutsInTheTests() throws ClassNotFoundException { 
    mock(Class.forName("java.lang.annotation.Annotation", false, SparseWeightedGraph_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("java.util.Comparator", false, SparseWeightedGraph_ESTest_scaffolding.class.getClassLoader()));
  }
